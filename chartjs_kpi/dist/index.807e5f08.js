...
})({"hblbx":[function(require,module,exports) {
...
(async function() {
    const data = require("ee851d95de33169");
    new (0, _autoDefault.default)(document.getElementById("charts"), {
        type: "line",
        data: {
            labels: data.xs,
            datasets: [
...
(async function() {
    const data = require("a6a661d0d50c0e79");
    new (0, _autoDefault.default)(document.getElementById("charts"), {
        type: "bar",
        data: {
            labels: data.xs,
...
},{"chart.js/auto":"d8NN9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","ee851d95de33169":"5ClLW","a6a661d0d50c0e79":"dxEJP"}],"d8NN9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"5ClLW":[function(require,module,exports) {
module.exports = JSON.parse('{"xs":["Jan21","Feb21","M\xe4r21","Apr21","Mai21","Jun21","Jul21","Aug21","Sep21","Okt21","Nov21","Dez21","Jan22","Feb22","M\xe4r22","Apr22","Mai22","Jun22","Jul22","Aug22","Sep22","Okt22","Nov22","Dez22","Jan23","Feb23","M\xe4r23","Apr23","Mai23","Jun23","Jul23","Aug23"],"vals":[1.1,1.3,1.8,2.3,2.4,3.1,3.3,4.6,4.6,5,5.8,7.4,8.8,12,13.7,11.2,12.4,13.7,17.9,19.4,24,24,23.9,27.9,35,50,55,50,80,90,85,70],"name":"share of teams constituted as circles"}');

},{}],"dxEJP":[function(require,module,exports) {
module.exports = JSON.parse('{"xs":"involuntary headcount change (FTE)","vals":[-17.647058823529413,-54.41176470588235,98.0392156862745]}');

},{}]},["hblbx","kkiZQ"], "kkiZQ", "parcelRequire30ab")
