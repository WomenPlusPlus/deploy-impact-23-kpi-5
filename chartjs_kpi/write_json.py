...
def generate_linechart(kpi_id, timefrom=(2023,1), timeto=(2023,12), fname="data/linedata.json"):
...
def generate_barchart(kpi_ids, fname="data/bardata.json"):
    """
